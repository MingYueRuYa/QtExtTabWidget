...
class App:
    ...
    def _compile_code(self):
        ...
        if os.path.isabs(self.compile_file):
            ...
            print('devenv ' + solution_file + ' ' + compile_parameter);
    ...
    def _parse_args(self, args):
        ...
        parser.add_argument('-a', '--compileargs', default='Debug|x86', type=str,
                            help='compile project with args, for example:"Debug|x86" or "Release|x86". default '
                                 'value: "Debug|x86"')
