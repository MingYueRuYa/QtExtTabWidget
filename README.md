...
```bat
usage: compile.py [-h] [-u] [-r] [-k] [-s] [-c] [-a COMPILEARGS] [-p CONFIGPATH]
...
optional arguments:
  ...
  -r, --resource        rebuild resource:for example Qt qrc file.
  -k, --kill            kill target process
  -s, --start           start target process
  -c, --compile         compile project
  -a COMPILEARGS, --compileargs COMPILEARGS
                        compile project with args, for example:"Debug|Win32". default value: "Debug|Win32"
